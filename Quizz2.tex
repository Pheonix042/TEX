...
\\
\therefore,
$\frac{\partial \psi_{0}}{\partial I_{1}}$ $\frac{\partial I_{1}}{\partial C_{ij}}$=$\frac{\mu}{2} \delta_{ij}$\\
...
Now for cauchy stress is given by,\\
...
Now relating trusdell and Jauman for Kirchoff stress:\\
...
$\therefore C^{S}_{ijkl} = 2\frac{\partial S_{ij}}{\partialC_{kl}}$\\
